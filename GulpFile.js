...
let path = {
  build: {
    ...
    json: project_folder + "/json/", // Добавьте эту строку
...
gulp.task('purgecss', () => {
  return gulp.src(['./#src/css/bootstrap-grid.min.css', './#src/css/bootstrap.css']) // Specify the path to your bootstrap-grid.css file
    .pipe(purgecss({
...
let build = gulp.series(clean, gulp.series('purgecss'), gulp.parallel(js, json, css, html, images, fonts));
